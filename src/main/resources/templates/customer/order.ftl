                                ...
                                <td>
                                    ...
                                    <#if o.status == "3">
                                        | <a  href="#" data-toggle="modal" data-target="#confirmModal"
                                              data-id="${o.o_id}"> 确认收货 </a>
                                    </#if>
                                    <#if o.status == "2">
                                        | <a  href="#" data-toggle="modal" data-target="#transferModal"
                                              data-id="${o.o_id}"> 查看物流 </a>
                                    </#if>
                                    <#if o.status == "1">
                                        | <a  href="#" data-toggle="modal" data-target="#evaluateModal"
                                              data-id="${o.o_id}"> 评价 </a>
                                    </#if>
                                </td>
                            </tr>
...
<script type="text/javascript">
    ...
    $("#confirmModal").on("show.bs.modal", function (event) {
        ...
        id = button.data("id");
        var modal = $(this);
        modal.find('.modal-body').text('确认 收货 吗?');
    });

    $("#checkConfirm").click(function(){
        $.ajax({
            url: '${base}/customer/order/confirm',
            type: 'POST',
            data: $.param({'o_id':id}),
