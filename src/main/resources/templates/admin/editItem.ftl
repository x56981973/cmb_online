                ...
                <div class="grid-form1">
                    ...
                    <form class="form-horizontal" id="updateItem" enctype="multipart/form-data" method="post" target="rfFrame">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="description" name="description" value="${i.description}">
                            </div>
                            <div class="clearfix" style="margin-bottom: 20px"> </div>

                            <label class="col-sm-2 control-label hor-form">所属商家</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="username" name="username" value="${i.s_username}">
                            </div>
                            <div class="clearfix" style="margin-bottom: 20px"> </div>
